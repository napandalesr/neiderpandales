...
const Info = () => {
  ...
  return <section className='w-[90%] md:w-[300px] min-h-[653px] md:max-h-[98vh] md:ml-4 rounded-lg bg-white text-center drop-shadow-[6px_2px_10px_rgba(97,97,97,1)] relative z-10 mt-32 md:mt-0'>
    ...
    <section className='flex items-center w-full justify-center py-3'>
      ...
      <Link href={''}><Image src={'/icons/GitHub.png'} alt='GitHub' width={90} height={90}/></Link>
      <Link href={''}><Image src={'/icons/Gmail Logo.png'} alt='GitHub' width={90} height={90}/></Link>
    </section>
    <section className='flex justify-between h-24'>
      <button className='w-1/2 border-r-2 border-t-2 border-custom-accent flex justify-center items-center'><Image src={'/icons/download.png'} alt='GitHub' width={50} height={50}/> </button>
      <button className='w-1/2 flex border-t-2 border-custom-accent justify-center items-center'><Image src={'/icons/incoming-call.png'} alt='GitHub' width={58} height={64}/> </button>
    </section>
  </section>;
}
